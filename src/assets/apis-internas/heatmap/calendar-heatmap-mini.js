...
function calendarHeatmapMini() {
  ...
  var data = [];
  var max = null;
  var colorRange = ['#D8E6E7', '#422183']; // De um azul claro a um azul escuro
  ...
  function chart() {
    ...
    function drawChart() {
      var svg = d3.select(chart.selector())
        ...
        .attr('viewBox', legendEnabled ? '-15 -10 825 150' : '-15 -10 825 135')
        ...
        .each(function (d, i, g) {
          ...
          if (typeof onClick === 'function') {
            dayRect.on('click', function (d) {
              ...
              selectedDay = dayRect;
              selectedDay.style('stroke', 'rgb(126, 37, 138)');
